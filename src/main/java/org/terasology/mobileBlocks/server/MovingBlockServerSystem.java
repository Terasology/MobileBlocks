...
public class MovingBlockServerSystem extends BaseComponentSystem implements BlockMoveManager {
    ...
    public boolean moveBlock(Vector3i location, Direction direction, long moveTime) {
        ...
        try {
            ...
            movingEntity.addComponent(new MovingBlockComponent(block, location, moveLocation, gameTime,
                    gameTime + moveTime));
    ...
    @ReceiveEvent
    public void preventDamagingOfBlocks(BeforeDamagedEvent event, EntityRef entity,
                                        MovingBlockReplacementComponent movingBlockReplacementComponent) {
        event.consume();
    }
}
